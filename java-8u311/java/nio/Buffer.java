...
byte-buffer-as-xxx-buffer-B/L/RB/RL
direct-xxx-buffer--/R/RS/RU/S/U
heap-xxx-buffer--/R
xxx-buffer-spliterator
xxx - buffer {   // 含义： xxx 类型的 buffer, 就是将二进制数据转为 xxx 类型
...
heap- : 所创建的字节缓冲区就是在JVM堆中的，即JVM内部所维护的字节数组
{
使用场景：
