...
/*
character-data-0e  实现了 Thai 字符集
character-data-01  实现了 ASCII、ISO-8859-1、UTF-8、UTF-16 等字符集
character-data-02  实现了 UTF-16 字符集
character-data-03  实现了 EUC-KR 字符集
character-data-latin1  实现了 latin1 字符集
character-data-private-use  用于处理 Unicode 私有使用区域（Private Use Area）的字符属性和行为
character-data-undefined  用于处理未定义的 Unicode 字符的属性和行为。
